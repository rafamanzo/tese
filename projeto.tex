...
\chapter{Conceitos e tecnologias a estudar}
  \section{Equações diferenciais parciais}
    ...
    A equação de Hamilton-Jacobi (\ref{eq:hamilton-jacobi}) é uma EDP, conforme descrita abaixo. É uma formulação da mecânica clássica equivalente à de Newton, . É a única formulação da mecânica onde uma partícula pode ser representada como uma onda.
    ...
    Onde, $s_{i}$, $1 \leq i \geq n$, são as $n$ coordenadas generalizadas no espaço e $t$ o tempo.
